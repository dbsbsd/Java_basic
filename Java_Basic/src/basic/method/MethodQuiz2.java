...
//    	int idx = indexOf(foodName);
//    	if(idx == -1) {
//    		return false;
//    	}else {
//    		return true;
//    	}
    	return indexOf(foodName) != -1;
    }
	...
	static void modify(int foodIdx, String newFood) {
		foods[foodIdx] = newFood;
	}
	...
	public static void main(String[] args) {
        ...
        //라면의 존재 여부 출력
        System.out.println("라면의 존재여부 (T/F): " + include("라면"));
        
        //양념치킨의 존재 여부 출력
        System.out.println("양념치킨의 존재여부 (T/F): " + include("양념치킨"));
