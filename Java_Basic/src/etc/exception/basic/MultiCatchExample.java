	...
	public static void main(String[] args) {
        ...
        */
		...
		try {
			...
			System.out.println("정수만 입력해야제~");
		} catch(ArithmeticException e) {
			System.out.println("0으론 못나누제~");
		} catch(ArrayIndexOutOfBoundsException e) {
			System.out.println("인덱스 범위를 벗어났제~");
		} catch(Exception e) {
			System.out.println("예측 못했다리~");
			System.out.println(e.getMessage() + "가 에러였다고~?");
		}
