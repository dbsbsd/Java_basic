...
public class StringMethod {
	...
	public static void main(String[] args) {
		...
		int idx1 = str.indexOf("l"); // 앞에서부터 탐색함
		System.out.println("idx1: "+ idx1);
		
		int idx2 = str.lastIndexOf("l"); // 뒤에서부터 탐색함
		...
		System.out.println(nam + "님 하이용");
		
		// replace(old, new)
		// : 기존 문자열 내부의 old값을 모두 찾아서 new 문자열로 일괄 변경
		String java = "자바는 재밌습니다. 자바 커피는 맛없습니다.";
		...
		String pet = "멍멍이,야옹이,짹짹이,말랑이";
		String[] ani = pet.split(",");
